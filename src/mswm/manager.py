...
def build_default(input_path: str, use_cold_start=None):
    """
    Call RealizationBuilder class to generate realization and config files with default parameters
    """
    rb = RealizationBuilder(input_path, use_cold_start)
...
def build_fcst(input_path: str, calib_yaml: str, fcst_run_name: str, use_cold_start: bool):
    """
    Call RealizationBuilder class to generate forecast realization and config files
    """
    rb = RealizationBuilder(input_path, calib_yaml, fcst_run_name, use_cold_start)
